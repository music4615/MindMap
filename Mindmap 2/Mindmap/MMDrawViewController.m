...
- (void)callHiddenMenu:(UIImageView *)selected
{
    if (_hiddenMenu == nil) {
        //Create the ColorPickerViewController.
        _hiddenMenu = [[MMPickerViewController alloc] init];
        _hiddenMenu.type = @"Hidden";
        _hiddenMenu = [_hiddenMenu initWithStyle:UITableViewStylePlain];
        
        //Set this VC as the delegate.
        _hiddenMenu.delegate = self;
    }
    
    if (_hiddenMenuPopover == nil) {
        //The color picker popover is not showing. Show it.
        _hiddenMenuPopover = [[UIPopoverController alloc] initWithContentViewController:_hiddenMenu];
        [_hiddenMenuPopover presentPopoverFromRect:selected.frame inView:self.view
                          permittedArrowDirections:UIPopoverArrowDirectionAny animated:YES];
    }
    else {
        //The color picker popover is showing. Hide it.
        [_hiddenMenuPopover dismissPopoverAnimated:YES];
        _hiddenMenuPopover = nil;
    }
